  ...
  return (
    <div className="allProducts">
      <div className="products__top">
        <h2 className="products__title">Ommabop mahsulotlar</h2>
        <div className="products__top-right">
          <svg
            className="products__top-svg"
          ...
          <div className="newPrices__bottom">
            ...
            <div className="newPrices__boxes-price-box">
              <span className="newPrices__boxes-prices">
                ...
                <div className="allProduct__stars-box">
                  <svg
                    className="allProduct__star"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
      ...
      <button className="allProduct__button">
        Barchasini ko’rish
      </button>
    </div>
  );
